...
torchrun --nproc_per_node=8 scripts/train.py   configs/c4/length-512/ce-attn-ssm/OLMo-60M-ce-attn-ssm2.yaml   --run_name=OLMo-60M-ce-512-eyepe   --save_folder=workspace/OLMo-60M-ce-512-eyepe --swanlab --swanlab.entity=MiracleLpX --swanlab.project=RoPE --swanlab.name=OLMo-60M-ce-512-eyepe
...
torchrun --nproc_per_node=8 scripts/train.py   configs/c4/length-512/ce-attn-ssm/OLMo-60M-ce-attn-ssm.yaml   --run_name=OLMo-60M-ce-512-attn-ssm-c4   --save_folder=workspace/OLMo-60M-ce-512-attn-ssm-c4 --swanlab --swanlab.entity=MiracleLpX --swanlab.project=RoPE --swanlab.name=OLMo-60M-ce-512-attn-ssm-c4 
...
torchrun --nproc_per_node=4 scripts/train.py   configs/c4/length-1024/ce-attn-ssm/OLMo-60M-ce-attn-ssm.yaml   --run_name=OLMo-60M-ce-1024-attn-ssm-c4   --save_folder=workspace/OLMo-60M-ce-1024-attn-ssm-c4 --swanlab --swanlab.entity=MiracleLpX --swanlab.project=RoPE --swanlab.name=OLMo-60M-ce-1024-attn-ssm-c4 
